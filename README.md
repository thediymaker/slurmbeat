...
`${GOPATH}/src/github.com/thediymaker/slurmbeat`
...
```
git remote set-url origin https://github.com/thediymaker/slurmbeat
...
in the same directory with the name slurmbeat.
...
```
mkdir -p ${GOPATH}/src/github.com/thediymaker/slurmbeat
git clone https://github.com/thediymaker/slurmbeat ${GOPATH}/src/github.com/thediymaker/slurmbeat
```
